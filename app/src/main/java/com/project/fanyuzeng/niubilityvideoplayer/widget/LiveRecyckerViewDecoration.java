...
public class LiveRecyckerViewDecoration extends RecyclerView.ItemDecoration {
    ...
    public LiveRecyckerViewDecoration(Context context) {
        mContext = context;
    ...
    //设置每行都有devider  getItemOffsets 中为 outRect 设置的4个方向的值，将被计算进所有 decoration 的尺寸中，
